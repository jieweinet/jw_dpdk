...
#define I350_VF_INIT_TIMEOUT		200 /* Num of retries to clear RSTI */
...
#define I350_EITR(_n)		(0x01680 + ((_n) << 2))
#define I350_EICS		0x01520 /* Ext. Intr Cause Set -W0 */
#define I350_EIMS		0x01524 /* Ext. Intr Mask Set/Read -RW */
#define I350_EIMC		0x01528 /* Ext. Intr Mask Clear -WO */
#define I350_EIAC		0x0152C /* Ext. Intr Auto Clear -RW */
#define I350_EIAM		0x01530 /* Ext. Intr Ack Auto Clear Mask -RW */
#define I350_IVAR0		0x01700 /* Intr Vector Alloc (array) -RW */
...
s32 i350_promisc_set_vf(struct i350_hw *, enum i350_promisc_type);
#endif /* _I350_VF_H_ */
